    ...
    return GestureDetector(
      onTap: () {
        if (hostel.isVerified) {
          // Navigate to the hostel details page
          onTap();
        } else {
          // Show a snackbar that the hostel is not verified
          TLoaders.warningSnackbar(
              title: 'Hostel Not Verified',
              message:
                  'This hostel is not verified yet, Please wait for verification');
        }
      },
      child: Card(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              const SizedBox(width: 4),
                              Text(
                                ' ₹${(hostel.isVerified ? hostel.dummyPrice : (hostel.minAskedPrice * 1.2).toInt())}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall!
                                    .copyWith(
                          ...
                          Row(
                            children: [
                              Text(
                                '₹${(hostel.isVerified ? hostel.minPrice : hostel.minAskedPrice)}',
                                style: Theme.of(context)
                                    .textTheme
                                    .headlineMedium!
                                    .copyWith(
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: (hostel.isVerified
                              ? Colors.green
                              : TColors.warning),

                          side: BorderSide(
                              color: (hostel.isVerified
                                  ? Colors.green
                                  : TColors.warning)),
